...
const Glow = styled.div`
  ...
  top: 68px;
  bottom: 0;
  background: radial-gradient(72.04% 72.04% at 50% 3.99%, #000000 0%, rgba(0, 0, 0, 0) 100%);
  filter: blur(72px);
  border-radius: 24px;
  max-width: 480px;
  width: 100%;
...
const TitleText = styled.h1<{ isDarkMode: boolean }>`
  ...
  background: ${({ isDarkMode }) =>
    isDarkMode
      ? 'linear-gradient(20deg, rgba(255, 244, 207, 1) 10%, rgba(0, 0, 0, 1) 100%)'
      : 'linear-gradient(10deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 100%)'};
...
const ButtonCTA = styled(LandingButton)`
  background: linear-gradient(93.06deg, #000000 2.66%, #000000 98.99%);
  border: none;
